...
fdescribe('questionHeadingProcessor', () => {
    ...
    describe('#replacePlaceholders', () => {
        it('replaces fuel type placeholder in question', () => {
            // given
        ...
        it('replaces multiple placeholders in question', () => {
            // given
        ...
        it('replaces placeholder which appears multiple times in question', () => {
            // given
