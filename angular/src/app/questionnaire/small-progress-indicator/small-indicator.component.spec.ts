...
import {SmallIndicatorComponent} from './small-indicator.component';
...
describe('SmallIndicatorComponent', () => {
    let component: SmallIndicatorComponent;
    let fixture: ComponentFixture<SmallIndicatorComponent>;
    ...
    beforeEach(async(() => {
        TestBed.configureTestingModule({
            declarations: [SmallIndicatorComponent],
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(SmallIndicatorComponent);
