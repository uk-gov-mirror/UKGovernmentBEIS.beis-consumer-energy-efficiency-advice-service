...
export class HomeTypeQuestionComponent extends QuestionBaseComponent<HomeType> {
    ...
    constructor(responseData: ResponseData) {
        ...
        this.homeTypeOptions = [
            ...
            new HomeTypeOption(HomeType.BasementFlat, 'basement-flat'),
            ...
            new HomeTypeOption(HomeType.DetachedBungalow, 'bungalow-detached'),
            new HomeTypeOption(HomeType.SemiDetachedBungalow, 'bungalow-attached'),
            new HomeTypeOption(HomeType.MidTerraceBungalow, 'bungalow-mid-terrace'),
            new HomeTypeOption(HomeType.EndTerraceBungalow, 'bungalow-end-terrace'),
