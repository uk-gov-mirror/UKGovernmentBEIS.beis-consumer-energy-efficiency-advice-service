...
describe('PropertyDevaluationQuestionComponent', () => {
    let component: PropertyDevaluationQuestionComponent;
    let fixture: ComponentFixture<PropertyDevaluationQuestionComponent>;

    beforeEach(async(() => {
        TestBed.configureTestingModule({
            declarations: [PropertyDevaluationQuestionComponent],
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(PropertyDevaluationQuestionComponent);
