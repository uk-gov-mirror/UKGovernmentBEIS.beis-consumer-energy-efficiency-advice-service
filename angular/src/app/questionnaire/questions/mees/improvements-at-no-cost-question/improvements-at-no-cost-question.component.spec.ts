...
describe('ImprovementsAtNoCostQuestionComponent', () => {
    let component: ImprovementsAtNoCostQuestionComponent;
    let fixture: ComponentFixture<ImprovementsAtNoCostQuestionComponent>;

    beforeEach(async(() => {
        TestBed.configureTestingModule({
            declarations: [ImprovementsAtNoCostQuestionComponent],
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(ImprovementsAtNoCostQuestionComponent);
