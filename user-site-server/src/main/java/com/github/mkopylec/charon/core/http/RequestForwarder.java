...
/**
 * This is a monkey patch for charon-spring-boot-starter
 * pending https://github.com/mkopylec/charon-spring-boot-starter/issues/45
 *
 * The only method that has changed is forwardHttpRequest
 */
