...
public class PdfLandlordRecommendationParams extends PdfRecommendationParams {
    ...
    public String getSubheading() {
        ...
        return numberOfRecommendations == 1
                ...
                : "You have added " + numberOfRecommendations + " recommendations to your plan. You'll find all the steps and things your landlord needs to implement those measures.";
    }
