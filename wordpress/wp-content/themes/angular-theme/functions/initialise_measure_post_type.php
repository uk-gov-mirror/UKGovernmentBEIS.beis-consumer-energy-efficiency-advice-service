        ...
        acf_add_local_field_group(array (
            ...
            'fields' => array (
                ...
                array(
                    ...
                    'label' => 'TrustMark Trade Codes ',
                    'name' => 'trustmark_trade_codes',
                    'instructions' => 'A list of TrustMark trade codes to fetch installers from their API.',
                    'type' => 'repeater',
                    'required' => 0,
                    'conditional_logic' => 0,
                    'wrapper' => array(
                ...
                array (
                    'key' => 'field_5f3116f0ac92d',
                    'label' => 'Installation cost lower bound',
                    'name' => 'installation_cost_lower_bound',
                    'type' => 'number',
                    'instructions' => 'A lower bound (in pounds) for the average installation cost of this measure. This is only required if the measure is not recommended by the BRE API.',
                    'required' => 0,
                    'default_value' => '',
                    'placeholder' => '',
                    'prepend' => '',
                ...
                array (
                    'key' => 'field_5f311711ac92e',
                    'label' => 'Installation cost upper bound',
                    'name' => 'installation_cost_upper_bound',
                    'type' => 'number',
                    'instructions' => 'An upper bound (in pounds) for the average installation cost of this measure. This is only required if the measure is not recommended by the BRE API.',
                    'required' => 0,
                    'default_value' => '',
                    'placeholder' => '',
                    'prepend' => '',
                ...
                array (
                    'key' => 'field_5f311723ac92f',
                    'label' => 'Lifetime',
                    'name' => 'lifetime',
                    'type' => 'number',
                    'instructions' => 'The average lifetime (in years) of this measure. This is only required if the measure is not recommended by the BRE API.',
                    'required' => 0,
                    'default_value' => '',
                    'placeholder' => '',
                    'prepend' => '',
